        ...
        public string RegisterNewUser(RegisterViewModel registerView)
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        responseMsg = "success";
                        string msgBody = "Dear user,<br>You have been nominated for competency assessment.<br /> Please access the portal using user ID " + registerView.UserId + " and Password " + otp + "<br><br>Regards,<br>(Its an autogenerated mail please don't reply)";
                        string emailSubject = "Assessment Registration Confirmation";
                        string fromEmail = "gattu.sreeni@gmail.com";

                        utility.SendEmail(
                            fromEmail,
                            newUser.Email,                                           emailSubject,
                            msgBody
                        );
